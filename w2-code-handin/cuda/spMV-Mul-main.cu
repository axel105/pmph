...
int SparseMatVctMult(int block_size, int mat_rows, int vct_size) {
    ...
    { // GPU execution    
        ...
        unsigned int num_blocks     = tot_size / block_size + 1;  // dummy value ... fill in your implementation ... 
        unsigned int num_blocks_shp = mat_rows / block_size + 1;  // dummy value ... fill in your implementation ...
